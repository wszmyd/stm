...
int main(void)
{
  ...
  while (1)
  {
      if (is_button_pressed(0)) {
          // After pressing the button, turn off the LED
          led_set(led, false);

          // Increase the value of the led variable
          led++;
      ...
      if (is_button_pressed(1)) {
          ...
          // Decrease the value of the led variable
          led--;
          // Check if it exceeds the range
          if (led < 0) {
              led = 8;
          ...
          // Delay to reduce bouncing after button release
          HAL_Delay(20);
      }
